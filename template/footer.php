        <footer class="main-footer text-right">
            ...
            <span class="visible-xs-inline-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">Powered by <b>ShadowX</b> <?php echo $version; ?> <a href="tos.php" target="_tos">服务条款</a></span>
        </footer>
    </div>
    <!-- ./wrapper -->
</body>
